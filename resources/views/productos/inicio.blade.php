        ...
        <div class="vm-table-card">
            <div class="overflow-x-auto">
                <table class="vm-table">
                    <thead class="vm-table-header"><tr><th class="vm-table-th">Imagen</th><th class="vm-table-th">Vehiculo</th><th class="vm-table-th">Marca</th><th class="vm-table-th">Modelo</th><th class="vm-table-th">Tipo</th><th class="vm-table-th">Color</th><th class="vm-table-th">Proveedor</th><th class="vm-table-th">Precio</th><th class="vm-table-th">Estado</th><th class="vm-table-th text-right">Acciones</th></tr></thead>
                    <tbody>
                        @forelse ($productos as $producto)
                            <tr class="vm-table-tr">
                                <td class="vm-table-td">@include('plantilla.imagen-tabla', ['imagen' => $producto->imagen_principal, 'alt' => $producto->nombre])</td>
                                <td class="vm-table-td font-bold text-black">{{ $producto->nombre }}<p class="text-xs text-gray-400">{{ $producto->numero_serie ?? 'Sin numero de serie' }}</p></td>
