...
@section('dinamico')
    <section class="vm-page-section">
        <div
            class="mx-auto grid min-h-[calc(100vh-180px)] max-w-screen-xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            <div>
                <span class="vm-badge">
                    Veloce Motors
                </span>
                ...
                <p class="mt-5 max-w-xl text-lg leading-8 text-gray-700">
                    Accede para consultar tus pedidos, registrar compras y dar seguimiento a tus solicitudes dentro de
                    Veloce Motors.
                </p>
                    ...
                    <form action="#" method="POST" class="space-y-5">
                        ...
                        <div>
                            <div class="mb-2 flex items-center justify-between gap-4">
                                ...
                                <a href="#"
                                    class="text-xs font-medium text-gray-500 transition hover:text-black">Olvide mi
                                    contrasena</a>
                            </div>
                ...
                <div class="vm-card-form-muted">
                    <div class="mb-6 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-sm leading-6 text-gray-500">Registrate para poder comprar vehiculos y
                                consultar tus movimientos.</p>
                        </div>
                        <span
                            class="inline-flex self-start rounded-full border border-black bg-white px-3 py-1 text-xs font-bold uppercase tracking-wider text-black">
                            Nuevo cliente
                        </span>
                    </div>
