            ...
            <form action="/pagos" method="POST" class="space-y-6">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <select id="pedido_id" name="pedido_id" class="block w-full rounded-xl border border-gray-200 bg-white p-3 text-black focus:border-black focus:ring-black/10" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="monto" name="monto" class="block w-full rounded-xl border border-gray-200 bg-white p-3 text-black focus:border-black focus:ring-black/10" required>
                    </div>

                    <div>
                        <label for="fecha_pago" class="mb-2 block text-sm font-bold text-black">Fecha del pago</label>
                        <input type="date" id="fecha_pago" name="fecha_pago" class="block w-full rounded-xl border border-gray-200 bg-white p-3 text-black focus:border-black focus:ring-black/10" required>
                    </div>
                ...
                <div class="flex justify-end border-t border-gray-200 pt-6">
                    <button type="submit" class="rounded-xl bg-black px-8 py-3 font-black text-white transition hover:bg-gray-800">Guardar pago</button>
                </div>
            </form>
        </div>
    </div>
