            ...
            <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
                <form action="/productos-pedido" method="POST" class="space-y-6">
                    ...
                    <div class="flex flex-col gap-3 border-t border-gray-200 pt-6 sm:flex-row sm:justify-end">
                        <button type="reset"
                            class="rounded-xl border border-gray-200 px-6 py-3 font-bold text-gray-700 transition hover:border-black hover:text-black ">Limpiar</button>
                        <button type="submit"
                            class="rounded-xl bg-black px-8 py-3 font-black text-white transition hover:bg-gray-800">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
