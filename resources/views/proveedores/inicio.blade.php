                    ...
                    <table class="vm-table">
                        <thead class="vm-table-header">
                            <tr>
                                ...
                                <th class="vm-table-th">Contacto</th>
                            ...
                            @forelse ($proveedores as $proveedor)
                                <tr class="vm-table-tr">
                                    ...
                                    <td class="vm-table-td"><span
                                            class="rounded-full border border-red-500/50 px-3 py-1 text-xs font-bold text-red-200">{{ $proveedor->estado }}</span>
                                    </td>
                                    <td class="vm-table-td text-right">
                                        <div class="flex justify-end gap-2"><a href="/proveedor/{{ $proveedor->id }}"
                                                class="vm-btn-outline !px-3 !py-1 text-xs">Ver</a><a
                                                href="/proveedor/{{ $proveedor->id }}/editar"
                                                class="vm-btn-solid !px-3 !py-1 text-xs">Editar</a><a
                                                href="/proveedor/{{ $proveedor->id }}/eliminar"
                                                class="vm-btn-outline !px-3 !py-1 text-xs">Eliminar</a></div>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="6" class="vm-table-td py-10 text-center">No hay proveedores registrados.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
