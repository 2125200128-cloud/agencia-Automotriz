    ...
    <section class="vm-page-section">
        <div class="vm-container-lg">
            <div class="vm-page-header mb-8">
                <p class="vm-header-tag">Tabla proveedores</p>
                <h1 class="vm-header-title">Nuevo proveedor</h1>
                <p class="vm-header-desc">Registra un nuevo proveedor comercial.</p>
            </div>
                ...
                <form action="/proveedor" method="POST" class="space-y-6">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div><label class="vm-input-label" for="contacto">Contacto</label><input class="vm-input-text"
                                id="contacto" name="contacto" value="{{ old('contacto') }}"></div>
                        ...
                        <div><label class="vm-input-label" for="correo">Correo</label><input class="vm-input-text"
                                type="email" id="correo" name="correo" value="{{ old('correo') }}"></div>
