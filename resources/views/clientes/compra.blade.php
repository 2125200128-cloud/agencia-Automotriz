        ...
        <div class="grid gap-8 lg:grid-cols-[1fr_350px]">
            <div class="vm-card-form">
                <form action="#" method="POST" class="space-y-6">
                    @csrf
                    <div>
                        <h3 class="text-lg font-bold text-black mb-4 border-b border-gray-200 pb-2">Datos Personales</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-black mb-4 border-b border-gray-200 pb-2">Método de Adquisición</h3>
                        <div class="grid gap-6 md:grid-cols-2">
                            <div>
            ...
            <div>
                <div class="sticky top-28 vm-card-form">
                    ...
                    <div class="space-y-4">
                        <div class="h-40 w-full rounded-xl bg-gray-100 overflow-hidden flex items-center justify-center">
                            <span class="text-sm text-gray-500 font-bold">Veloce Premium</span>
                        </div>
                        <div>
                            <h4 class="font-bold text-black text-lg" id="display-compra-auto-nombre">Audi RS 7 Sportback</h4>
                        ...
                        <div class="pt-4 border-t border-gray-200 flex justify-between items-end">
                            ...
                            <span class="font-black text-black text-xl" id="display-compra-auto-precio">$1,890,000 MXN</span>
                        </div>
                    </div>
                </div>
            </div>
