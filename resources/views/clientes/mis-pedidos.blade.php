    ...
    <div class="vm-container-lg">
        ...
        <div class="vm-card-form">
            ...
            <div class="flex gap-3">
                <input type="text" id="buscar-folio" placeholder="Ingresa tu número de folio (ej: ORD-1024)" class="vm-input-text flex-1">
        ...
        <div id="resultado-pedido" class="mt-8 space-y-6">
            <div class="vm-card-form">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <span class="self-start rounded-full bg-gray-100 px-4 py-1.5 text-sm font-bold text-gray-700">Pagado</span>
                </div>
                <div class="mt-6 vm-card !bg-gray-50">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <p class="text-xl font-black text-black">$1,850,000 <span class="text-xs font-normal text-gray-400">MXN</span></p>
                    </div>
                </div>
                <div class="mt-8">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute top-5 left-5 h-0.5 bg-gray-800 transition-all duration-500" style="width: 33%;"></div>

                        <div class="relative flex justify-between">
                            <div class="flex flex-col items-center text-center w-1/4">
                                <div class="flex h-10 w-10 items-center justify-center rounded-full bg-black text-white font-bold text-sm ring-4 ring-gray-200">
                                    ✓
                                </div>
                            ...
                            <div class="flex flex-col items-center text-center w-1/4">
                                <div class="flex h-10 w-10 items-center justify-center rounded-full border-2 border-gray-300 bg-gray-100 text-gray-500 font-bold text-sm">
                                    3
                                </div>
            ...
            <div class="vm-card flex items-start gap-4">
                <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-100 text-gray-700 text-lg">?</div>
                <div>
                    <p class="font-bold text-black">¿Tienes dudas sobre tu pedido?</p>
                    <p class="mt-1 text-sm text-gray-400">Contáctanos al <span class="text-black font-bold">(55) 1234-5678</span> o escríbenos a <span class="text-gray-700 font-bold">soporte@velocemotors.mx</span></p>
                </div>
            </div>
        </div>
    </div>
