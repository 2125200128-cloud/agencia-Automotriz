        ...
        <div class="vm-card-form">
            <form action="#" method="POST" class="space-y-6">
                ...
                <div class="vm-card flex items-center gap-4 mb-6">
                    <div class="h-14 w-24 rounded bg-gray-100 overflow-hidden flex-shrink-0 flex items-center justify-center">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="date" id="fecha" name="fecha" min="{{ date('Y-m-d') }}" class="vm-input-text" required>
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="licencia" name="licencia" placeholder="Ej. A1234567" class="vm-input-text" required>
                    </div>
                </div>
