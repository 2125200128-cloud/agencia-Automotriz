...
<section class="min-h-screen bg-black px-4 py-10 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-4xl">
        <div class="mb-8 border-l-4 border-white/30 pl-5">
            <p class="text-sm font-semibold uppercase tracking-[0.35em] text-zinc-300">Tabla colores</p>
            <h1 class="mt-3 text-3xl font-black text-white sm:text-4xl">Formulario de Colores</h1>
            <p class="mt-2 text-gray-400">En.</p>
        </div>
            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="imagen" name="imagen" placeholder="imagenes/colores/rojo.jpg" class="block w-full rounded-xl border border-white/10 bg-black/80 p-3 text-white focus:border-white/30 focus:ring-white/30">
                    </div>
                </div>
