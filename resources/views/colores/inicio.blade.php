                            ...
                            @forelse ($colores as $color)
                                <tr class="vm-table-tr">
                                    ...
                                    <td class="vm-table-td text-right">
                                        <div class="flex justify-end gap-2"><a href="/colores/{{ $color->id }}"
                                                class="vm-btn-outline !px-3 !py-1 text-xs">Ver</a><a
                                                href="/colores/{{ $color->id }}/editar"
                                                class="vm-btn-solid !px-3 !py-1 text-xs">Editar</a><a
                                                href="/colores/{{ $color->id }}/eliminar"
                                                class="vm-btn-outline !px-3 !py-1 text-xs">Eliminar</a></div>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="vm-table-td py-10 text-center">No hay colores registrados.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
