...
<section class="min-h-screen bg-white px-4 py-10 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-screen-2xl">
        ...
        <div class="mt-6">
            <a href="/pedido/formulario" class="inline-flex rounded-xl bg-black px-6 py-3 text-sm font-black uppercase tracking-wide text-white transition hover:bg-gray-800">Registrar pedido</a>
        </div>

        <div class="mt-8 rounded-xl border border-gray-200 bg-white p-5">
            <div class="grid gap-4 lg:grid-cols-[1fr_200px_200px_auto]">
                <input type="search" placeholder="Buscar por folio o cliente..." class="w-full rounded-lg border border-gray-200 bg-white p-3 text-black placeholder:text-gray-500 focus:border-black focus:ring-black/10">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse ($pedidos as $pedido)
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 font-bold text-black">#ORD-{{ str_pad($pedido->id, 4, '0', STR_PAD_LEFT) }}</td>
