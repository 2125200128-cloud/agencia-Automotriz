            ...
            <form action="/pedido" method="POST" class="space-y-6">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="date" id="fecha" name="fecha" class="block w-full rounded-xl border border-gray-200 bg-white p-3 text-black focus:border-black focus:ring-black/10" required>
                    </div>

                    <div>
                        <label for="descuento" class="mb-2 block text-sm font-bold text-black">Descuento</label>
                        <input type="number" step="0.01" min="0" id="descuento" name="descuento" value="0" class="block w-full rounded-xl border border-gray-200 bg-white p-3 text-black focus:border-black focus:ring-black/10" required>
                    </div>

                    <div>
                        <label for="iva" class="mb-2 block text-sm font-bold text-black">IVA</label>
                        <input type="number" step="0.01" min="0" id="iva" name="iva" value="0" class="block w-full rounded-xl border border-gray-200 bg-white p-3 text-black focus:border-black focus:ring-black/10" required>
                    </div>

                    <div>
                        <label for="total" class="mb-2 block text-sm font-bold text-black">Total</label>
                        <input type="number" step="0.01" min="0" id="total" name="total" class="block w-full rounded-xl border border-gray-200 bg-white p-3 text-black focus:border-black focus:ring-black/10" required>
                    </div>
