    ...
    <section class="vm-page-section">
        <div class="vm-container-lg">
            ...
            <div class="vm-card-form space-y-4">
                ...
                <p><strong>Imagen:</strong> {{ $marca->imagen ?? 'Sin imagen' }}</p>
                <div class="flex gap-3 pt-4"><a href="/marcas" class="vm-btn-secondary">Volver</a><a
                        href="/marcas/{{ $marca->id }}/editar" class="vm-btn-primary">Editar</a></div>
            </div>
        </div>
    </section>
@endsection
