                    ...
                    <tbody>
                        @forelse ($marcas as $marca)
                            <tr class="vm-table-tr">
                                ...
                                <td class="vm-table-td text-right"><div class="flex justify-end gap-2"><a href="/marcas/{{ $marca->id }}" class="vm-btn-outline !px-3 !py-1 text-xs">Ver</a><a href="/marcas/{{ $marca->id }}/editar" class="vm-btn-solid !px-3 !py-1 text-xs">Editar</a><a href="/marcas/{{ $marca->id }}/eliminar" class="vm-btn-outline !px-3 !py-1 text-xs">Eliminar</a></div></td>
                            </tr>
                        @empty
