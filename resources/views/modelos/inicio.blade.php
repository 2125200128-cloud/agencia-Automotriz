        ...
        <div class="vm-table-card">
            <div class="overflow-x-auto">
                <table class="vm-table">
                    <thead class="vm-table-header"><tr><th class="vm-table-th">ID</th><th class="vm-table-th">Imagen</th><th class="vm-table-th">Marca</th><th class="vm-table-th">Nombre</th><th class="vm-table-th text-right">Acciones</th></tr></thead>
                    <tbody>
